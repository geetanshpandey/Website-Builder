...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex">
      ...
      {/* Main Content */}
      <motion.main
        className="flex-1 flex flex-col items-center justify-center bg-gray-100 p-6 -ml-20"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.5, duration: 0.5 }}
      >
        {/* Let's Get Started Heading */}
        <h1 className={`text-6xl font-bold mb-12 text-blue-600 ${caveat.className}`}>
          Let’s Get Started
        </h1>
        ...
        <div className="flex items-center space-x-4 mb-6">
          <Label className="text-lg font-medium">
            <span className={`text-4xl font-bold mb-8 mr-6 ${caveat.className}`} >Connect to Stripe </span></Label>
        </div>
        <Button className="mb-6 bg-blue-600 text-white px-8 py-2 rounded-lg hover:bg-blue-700 transition-all">
        ...
        <div className="flex items-center space-x-6 mb-6 mt-6">
          <Label className="text-lg font-medium">Agency Name</Label>
